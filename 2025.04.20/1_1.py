...
plt.savefig(dir_path / "all_WCSS_mixed.jpg", dpi=150)
...
# {2: np.float64(0.447), 3: np.float64(0.367), 4: np.float64(0.365), 5: np.float64(0.369), 6: np.float64(0.354), 7: np.float64(0.353)}