...
# Эксперимент № 3   Наилучшая полученная конфигурация гиперпараметров.
...
# Эксперимент № 9
# При 3 слоях (200 (relu), 100 (relu) и 10 (softmax) параметров), 10 эпохах, validation_split=0.25, learning_rate=0.0005
# Дальнейшее уменьшение скорости обучения положительного результата не дало
